...
function drawChartTask1() {
    ...
    data.addRows([
        ...
        ["Новини", "Головна", "Останні новини"],
        ["Історія", "Головна", "Історія факультету"],
        ["Галерея", "Головна", "Фотоальбоми"],

        ["Підрозділи", "", "Підрозділи факультету"],
        ["Деканат", "Підрозділи", "Адміністрація факультету"],
        ["Кафедра ПЗАС", "Підрозділи", "Кафедра ПЗАС"],
        ["Кафедра ІТ", "Підрозділи", "Кафедра Інформаційних технологій"],
        ["Кафедра ІСПР", "Підрозділи", "Кафедра Інтелектуальних систем"],

        ["Навчання", "", "Освітній процес"],
        ["Розклад", "Навчання", "Розклад занять"],
        ["Навчальні плани", "Навчання", "Освітні програми"],

        ["Самоврядування", "", "Структури самоврядування"],
        ["Вчена рада", "Самоврядування", "Науковий орган"],
        ["Студентська рада", "Самоврядування", "Рада студентів"],

        ["Наука", "", "Наукова діяльність"],
        ["Конференція", "Наука", "Конференції факультету"],

        ["Абітурієнту", "", "Інформація для вступників"],
        ["Правила прийому", "Абітурієнту", "Правила вступу"],
    ])
